...
if workdays <= 7:
    column_order = ['姓名', '工号', 'Base地', '岗位类别', '日志区间', '工作日', '工作日时长', '总日志时长', '请假时长', '日常日志时长', '项目日志时长', '项目日志占比', '排名', '日志时长考核', '填写天数', '邮箱']
elif workdays > 7:
    column_order = ['姓名', '工号', 'Base地', '岗位类别', '日志区间', '工作日', '工作日时长', '总日志时长', '请假时长', '日常日志时长', '项目日志时长', '项目日志占比', '排名', '填写天数', '邮箱']
